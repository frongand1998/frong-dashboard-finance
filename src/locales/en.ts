const en = {
  ...
  dashboard: {
    ...
    budgetAlertCenter: "Budget Alert Center",
    budgetAlertSummary: "budgets need attention",
    budgetAlertsClear: "All budgets are under control.",
    budgetAlertsClearHint: "No categories are near or over budget right now.",
  ...
  analytics: {
    ...
    spendingByDayOfWeek: "Spending by Day of Week",
    weekday: {
      sun: "Sun",
      mon: "Mon",
      tue: "Tue",
